  ...
  registerVisualContributions() {
    ...
    this.contributionRegistry.register({
      ...
      show: () => {
        ...
        if (!this.summaryChartManager?.isDisposed?.()) this.summaryChartManager?.resizeToContainer?.();
      },
      hide: () => {
  ...
  registerVisualContributions() {
    ...
    this.contributionRegistry.register({
      ...
      show: () => {
        ...
        if (!this.trendChartManager?.isDisposed?.()) this.trendChartManager?.resizeToContainer?.();
      },
      hide: () => {
